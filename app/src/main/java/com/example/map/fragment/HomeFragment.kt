...
import com.example.map.adapter.GooglePlaceAdapter
import com.example.map.adapter.InfoWindowAdapter
import com.example.map.models.GoogleResponseModel
import com.example.map.utility.State
import com.example.map.viewModels.LocationViewModel
...
////            chip.setPadding(8, 8, 8, 8)
////            chip.setTextColor(resources.getColor(R.color.white, null))
////            chip.chipBackgroundColor = resources.getColorStateList(R.color.vio, null)
////            chip.chipIcon = ResourcesCompat.getDrawable(resources, placeModel.drawableId, null)
////            chip.isCheckable = true
////            chip.isCheckedIconVisible = false
////            binding.placesGroup.addView(chip)
